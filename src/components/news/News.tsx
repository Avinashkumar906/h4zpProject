...
import { isTrue, optimizeData } from '../../util/mockData.util';
          ...
          {props.data?.list?.map((m, index) => (
            <Col key={`${props.id}-${index}`} xl={12} className="pb-5 mb-5">
              <Card
                ...
                className={`border-0 ${props.data?.theme}`}
                ref={dimention}
                data-aos="fade-up"
              >
                <Row>
                    ...
                    <Card.Body className="h-100">
                      ...
                      >
                        ...
                        <Card.Title className="text-center mb-2">
                          <Link to={m.BtnUrl} className="btn btn-dark">
                            {m.BtnText}
                          </Link>
                        </Card.Title>
